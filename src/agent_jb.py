...
class Agent:
    def __init__(self, rob):
        ...
        self.threshold = 0.10 # if agent distance to object < threshold, then sensor triggered
    ...
    def get_state(self):
        ...
        # [most right, front right, front, front left, most left]
...
def train_loop(rob, episodes=5, steps=200):
    """
    ...
    for episode in range(episodes):
        ...
        for key, values in agent.q_values.items():
            print(f"Q-value keys: Forward   Left   Left Long   Right   Right Long")            
            if key == 0:
                print(f"State: No Objects, Q-values: {values}")
            elif key == 1:
                print(f"State: Object to Right, Q-values: {values}")
            elif key == 2:
                print(f"State: Object in Front, Q-values: {values}")
            elif key == 3:
                print(f"State: Object to Left, Q-values: {values}")
